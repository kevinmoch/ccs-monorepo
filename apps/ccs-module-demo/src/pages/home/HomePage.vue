...
import { createAttendanceService, getRuntimeOptions, getElectron } from '@ccs/shared';
import type { PunchType, LocationFix, AttendanceRecord, MapLink } from '@ccs/shared';
...
<template>
  <section class="attendance-page">
    ...
    <section class="platform-panel">
      <div class="platform-card" v-for="option in getRuntimeOptions()" :key="option.kind" :class="{ active: option.kind === runtime.kind }">
...
.attendance-hero {
  ...
  border-radius: 8px;
  background: linear-gradient(135deg, rgba(20, 184, 166, 0.18), rgba(37, 99, 235, 0.1) 48%, rgba(245, 158, 11, 0.13)), #ffffff;
