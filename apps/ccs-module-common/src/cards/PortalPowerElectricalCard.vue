  ...
  <CardShell class="portal-shell">
    <div class="portal-root">
      ...
      <div class="portal-main">
        <h2 class="portal-title" :title="root ? pickTitle(root, language) : ''">{{ root ? pickTitle(root, language) : '' }}</h2>
...
/** 强电专业（L2-10）节点 */
const root = computed(() => findMenuNode(props.menuData ?? [], 'L2-10'));
const split = computed(() => splitBySeperateLine(root.value?.children ?? [], root.value?.seperateLine));
